...
return array(
    ...
    'custom' => array(
        'nom' => array(
            'regex' => 'Le nom doit contenir entre 3 et 30 caractères alphabétiques (les espaces et aphostrophes sont autorisés).',
        ),
        'telephone' => array(
            'regex' => 'Le numéro de téléphone doit comporter 10 chiffres et commencer par 0.',
        ),
    ),
    /*
      |--------------------------------------------------------------------------
